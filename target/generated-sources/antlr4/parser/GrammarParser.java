...
public class GrammarParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'/'", "'char'", "'return'", "'!='", "'float'", "'||'", "'while'", 
		"';'", "'{'", "'&&'", "'='", "'}'", "'if'", "'<='", "'printsp'", "'int'", 
		"'print'", "'('", "'*'", "','", "'.'", "'var'", "'println'", "':'", "'>='", 
		"'['", "'=='", "'<'", "']'", "'>'", "'!'", "'%'", "'else'", "'read'", 
		"')'", "'+'", "'struct'", "'-'", "INT", "FLOAT", "IDENT", "LINE_COMMENT", 
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__16) | (1L << T__1) | (1L << IDENT))) != 0)) {
				{
				{
				setState(24); ((StartContext)_localctx).global = global();
	...
	public final GlobalContext global() throws RecognitionException {
		...
		try {
			...
			case T__1:
				...
				setState(33); ((GlobalContext)_localctx).name = match(IDENT);
				setState(34); match(T__29);
				setState(38);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==IDENT) {
					{
					{
					setState(35); ((GlobalContext)_localctx).structField = structField();
			...
			case T__16:
				...
				{
				setState(44); ((GlobalContext)_localctx).varDef = varDef();
			...
			case IDENT:
				...
				{
				setState(47); ((GlobalContext)_localctx).func = func();
	...
	public final FuncContext func() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(52); ((FuncContext)_localctx).name = match(IDENT);
				setState(53); match(T__20);
				setState(54); ((FuncContext)_localctx).lp = defineFuncParams();
				setState(55); match(T__3);
				setState(56); match(T__14);
				setState(57); ((FuncContext)_localctx).type = type();
				...
				while (_la==T__16) {
					{
					{
					setState(59); ((FuncContext)_localctx).varDef = varDef();
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__31) | (1L << T__25) | (1L << T__23) | (1L << T__21) | (1L << T__20) | (1L << T__15) | (1L << T__10) | (1L << T__7) | (1L << T__4) | (1L << INT) | (1L << FLOAT) | (1L << IDENT) | (1L << CHAR))) != 0)) {
					{
					{
					setState(65); ((FuncContext)_localctx).statement = statement();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(74); ((FuncContext)_localctx).name = match(IDENT);
				setState(75); match(T__20);
				setState(76); ((FuncContext)_localctx).lp = defineFuncParams();
				...
				while (_la==T__16) {
					{
					{
					setState(79); ((FuncContext)_localctx).varDef = varDef();
					((FuncContext)_localctx).lvd.add(((FuncContext)_localctx).varDef);
					}
					}
					setState(84);
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__31) | (1L << T__25) | (1L << T__23) | (1L << T__21) | (1L << T__20) | (1L << T__15) | (1L << T__10) | (1L << T__7) | (1L << T__4) | (1L << INT) | (1L << FLOAT) | (1L << IDENT) | (1L << CHAR))) != 0)) {
					{
					{
					setState(85); ((FuncContext)_localctx).statement = statement();
					((FuncContext)_localctx).ls.add(((FuncContext)_localctx).statement);
					}
					}
					setState(90);
	...
	public static class DefineFuncParamsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterDefineFuncParams(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitDefineFuncParams(this);
		}
	}
	...
	public final DefineFuncParamsContext defineFuncParams() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				enterOuterAlt(_localctx, 1);
				{
				setState(96); ((DefineFuncParamsContext)_localctx).defineFuncParamsList = defineFuncParamsList();
	...
	public static class DefineFuncParamsListContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterDefineFuncParamsList(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitDefineFuncParamsList(this);
		}
	}
	...
	public final DefineFuncParamsListContext defineFuncParamsList() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(102); ((DefineFuncParamsListContext)_localctx).IDENT = match(IDENT);
				setState(103); match(T__14);
				setState(104); ((DefineFuncParamsListContext)_localctx).type = type();
				setState(105); match(T__18);
				setState(106); ((DefineFuncParamsListContext)_localctx).defineFuncParamsList = defineFuncParamsList();
				_localctx.ast.add(new VarDef(((DefineFuncParamsListContext)_localctx).IDENT,((DefineFuncParamsListContext)_localctx).type.ast));
					_localctx.ast.addAll(_localctx.ast);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(109); ((DefineFuncParamsListContext)_localctx).IDENT = match(IDENT);
				setState(110); match(T__14);
				setState(111); ((DefineFuncParamsListContext)_localctx).type = type();
				_localctx.ast.add(new VarDef(((DefineFuncParamsListContext)_localctx).IDENT,((DefineFuncParamsListContext)_localctx).type.ast));
				}
				break;
			}
	...
	public static class PassFuncParamsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterPassFuncParams(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitPassFuncParams(this);
		}
	}
	...
	public final PassFuncParamsContext passFuncParams() throws RecognitionException {
		...
		try {
			...
			case CHAR:
				enterOuterAlt(_localctx, 1);
				{
				setState(116); ((PassFuncParamsContext)_localctx).passFuncParamsList = passFuncParamsList();
	...
	public static class PassFuncParamsListContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterPassFuncParamsList(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitPassFuncParamsList(this);
		}
	}
	...
	public final PassFuncParamsListContext passFuncParamsList() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(122); ((PassFuncParamsListContext)_localctx).expression = expression(0);
				setState(123); match(T__18);
				setState(124); ((PassFuncParamsListContext)_localctx).passFuncParams = passFuncParams();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(127); ((PassFuncParamsListContext)_localctx).expression = expression(0);
				_localctx.ast.add(((PassFuncParamsListContext)_localctx).expression.ast);
				}
				break;
			}
	...
	public static class StructFieldContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterStructField(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitStructField(this);
		}
	}
	...
	public final StructFieldContext structField() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(132); ((StructFieldContext)_localctx).name = match(IDENT);
			setState(133); match(T__14);
			setState(134); ((StructFieldContext)_localctx).type = type();
			setState(135); match(T__30);
	...
	public final VarDefContext varDef() throws RecognitionException {
		...
		try {
			...
			setState(139); ((VarDefContext)_localctx).name = match(IDENT);
			setState(140); match(T__14);
			setState(141); ((VarDefContext)_localctx).type = type();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(145); ((StatementContext)_localctx).assigned = expression(0);
				setState(146); match(T__27);
				setState(147); ((StatementContext)_localctx).value = expression(0);
			...
			case 2:
				...
				setState(152); ((StatementContext)_localctx).returned = expression(0);
			...
			case 4:
				...
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__23) | (1L << T__21) | (1L << T__15))) != 0)) ) {
					((StatementContext)_localctx).print = (Token)_errHandler.recoverInline(this);
				}
				consume();
				setState(160); ((StatementContext)_localctx).printed = expression(0);
			...
			case 6:
				...
				{
				setState(167); ((StatementContext)_localctx).IDENT = match(IDENT);
				setState(168); match(T__20);
				setState(169); ((StatementContext)_localctx).parameters = passFuncParams();
			...
			case 7:
				...
				setState(175); ((StatementContext)_localctx).into = expression(0);
			...
			case 8:
				...
				setState(181); ((StatementContext)_localctx).condition = expression(0);
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__31) | (1L << T__25) | (1L << T__23) | (1L << T__21) | (1L << T__20) | (1L << T__15) | (1L << T__10) | (1L << T__7) | (1L << T__4) | (1L << INT) | (1L << FLOAT) | (1L << IDENT) | (1L << CHAR))) != 0)) {
					{
					{
					setState(184); ((StatementContext)_localctx).statement = statement();
				...
				if (_la==T__5) {
					...
					while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__31) | (1L << T__25) | (1L << T__23) | (1L << T__21) | (1L << T__20) | (1L << T__15) | (1L << T__10) | (1L << T__7) | (1L << T__4) | (1L << INT) | (1L << FLOAT) | (1L << IDENT) | (1L << CHAR))) != 0)) {
						{
						{
						setState(193); ((StatementContext)_localctx).statement = statement();
			...
			case 9:
				...
				setState(206); ((StatementContext)_localctx).condition = expression(0);
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__31) | (1L << T__25) | (1L << T__23) | (1L << T__21) | (1L << T__20) | (1L << T__15) | (1L << T__10) | (1L << T__7) | (1L << T__4) | (1L << INT) | (1L << FLOAT) | (1L << IDENT) | (1L << CHAR))) != 0)) {
					{
					{
					setState(209); ((StatementContext)_localctx).statement = statement();
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(222); ((ExpressionContext)_localctx).bool = expression(11);
			...
			case 2:
				...
				setState(226); ((ExpressionContext)_localctx).to = type();
				setState(227); match(T__8);
				setState(228); ((ExpressionContext)_localctx).from = expression(10);
			...
			case 3:
				...
				setState(232); ((ExpressionContext)_localctx).inside = expression(0);
			...
			case 4:
				{
				setState(236); ((ExpressionContext)_localctx).IDENT = match(IDENT);
				setState(237); match(T__20);
				setState(238); ((ExpressionContext)_localctx).parameters = passFuncParams();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__37) | (1L << T__19) | (1L << T__6))) != 0)) ) {
							((ExpressionContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						consume();
						setState(254); ((ExpressionContext)_localctx).right = expression(10);
					...
					case 2:
						...
						consume();
						setState(259); ((ExpressionContext)_localctx).right = expression(9);
						((ExpressionContext)_localctx).ast = new ArithmeticExpression(((ExpressionContext)_localctx).left.ast,((ExpressionContext)_localctx).op,((ExpressionContext)_localctx).right.ast);
						}
						break;
					case 3:
						...
						((ExpressionContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__34) | (1L << T__24) | (1L << T__13) | (1L << T__11) | (1L << T__10) | (1L << T__8))) != 0)) ) {
							((ExpressionContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						consume();
						setState(264); ((ExpressionContext)_localctx).right = expression(8);
					...
					case 4:
						...
						setState(268); ((ExpressionContext)_localctx).op = match(T__28);
						setState(269); ((ExpressionContext)_localctx).right = expression(7);
					...
					case 5:
						...
						setState(273); ((ExpressionContext)_localctx).op = match(T__32);
						setState(274); ((ExpressionContext)_localctx).right = expression(6);
						((ExpressionContext)_localctx).ast = new BooleanOfBooleansExpr(((ExpressionContext)_localctx).left.ast,((ExpressionContext)_localctx).op,((ExpressionContext)_localctx).right.ast);
						}
						break;
					case 6:
						...
						setState(278); match(T__12);
						setState(279); ((ExpressionContext)_localctx).index = expression(0);
						setState(280); match(T__9);
					...
					case 7:
						...
						setState(285); ((ExpressionContext)_localctx).IDENT = match(IDENT);
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				enterOuterAlt(_localctx, 4);
				{
				setState(298); ((TypeContext)_localctx).name = match(IDENT);
			...
			case T__12:
				...
				setState(301); ((TypeContext)_localctx).size = match(INT);
				setState(302); match(T__9);
				setState(303); ((TypeContext)_localctx).type = type();
				((TypeContext)_localctx).ast =  new ArrayType(new IntConstant(((TypeContext)_localctx).size),_localctx.ast);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\26\30\2\6\5\2\21\21\23\23\31\31\5\2\3\3\25\25\"\"\4\2&&((\7\2\6\6\20"+
		"\20\33\33\35\36  \u0155\2\35\3\2\2\2\4\64\3\2\2\2\6`\3\2\2\2\bf\3\2\2"+
		"\2\nt\3\2\2\2\fz\3\2\2\2\16\u0084\3\2\2\2\20\u0086\3\2\2\2\22\u008c\3"+
		"\2\2\2\24\u00dc\3\2\2\2\26\u00fc\3\2\2\2\30\u0134\3\2\2\2\32\34\5\4\3"+
		"\2\33\32\3\2\2\2\34\37\3\2\2\2\35\33\3\2\2\2\35\36\3\2\2\2\36 \3\2\2\2"+
		"\37\35\3\2\2\2 !\b\2\1\2!\3\3\2\2\2\"#\7\'\2\2#$\7+\2\2$(\7\13\2\2%\'"+
		"\5\20\t\2&%\3\2\2\2\'*\3\2\2\2(&\3\2\2\2()\3\2\2\2)+\3\2\2\2*(\3\2\2\2"+
		"+,\7\16\2\2,-\7\n\2\2-\65\b\3\1\2./\5\22\n\2/\60\b\3\1\2\60\65\3\2\2\2"+
