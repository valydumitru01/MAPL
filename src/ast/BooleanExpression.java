...
//	booleanExpression:expression -> left:expression  comparison:String  right:expression

public class BooleanExpression extends AbstractExpression {

	public BooleanExpression(Expression left, String comparison, Expression right) {
		this.left = left;
	...
	public BooleanExpression(Object left, Object comparison, Object right) {
