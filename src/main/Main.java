 ...
 */
public class Main {
	public static final String INPUT_FILE = "Ejemplos/GeneracionCodigo/prueba.txt"; // Fichero de prueba durante el desarrollo
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (errorManager.errorsCount() == 0)
        	...
        	System.err.println("El programa no se ha compilado correctamente, hay "+errorManager.errorsCount()+" errores");
        	System.err.println("NO SE HA GENERADO EL CODIGO");
        }
